 ...
 *
 */
	Configure::write('Routing.prefixes', array('admin','fb'));
 ...
 */
	Configure::write('Security.salt', '7efa5690ac80fad722469a4dda97b443330d1b38');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '306136396138333330333764373663');
