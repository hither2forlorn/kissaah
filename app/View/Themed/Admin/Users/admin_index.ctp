...
<div class="row">
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat blue-madison">
			...
			echo $this->Html->link('View more <i class="m-icon-swapright m-icon-white"></i>',
					array('controller' => 'users', 'action' => 'view', 'full_base' => true), 
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat green-haze">
			...
			<?php
			echo $this->Html->link('View more <i class="m-icon-swapright m-icon-white"></i>', 
					array('controller' => 'game_configures', 'action' => 'collage','Image Activity', 'full_base' => true), 
					array('class'=>'more', 'escape' => false));
			?>
		</div>
	</div>
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat purple">
			...
			<?php
			echo $this->Html->link('View more <i class="m-icon-swapright m-icon-white"></i>', 
					array('controller' => 'comments', 'action' => 'index', 'full_base' => true),
					array('class'=>'more', 'escape' => false));
			?>                    
		</div>
	</div>
			...
			<div class="portlet-body">
				<div class="task-content">
					<div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="1">
						...
						echo isset($ans['user_name'])? $ans['user_name']: $ans['user_email'];
						echo '  uploaded image for  ';
						echo $this->Html->link(
								$ans["GameConfigure_title"], 
								array('controller' => 'configurations', 'action' => 'collage', $ans['GameConfigure_title'], 'full_base' => true));
									?></span>
								</div>
							</li>
							<?php } else { ?>
							<li>
								<div class="task-title">
									<span class="task-title-sp"><?php 
									echo isset($ans['author_name'])? $ans['author_name']: $ans['author_email'];
									echo '  posted a ';
									echo $this->Html->link('Comment', 
											array('controller' => 'comments', 'action' => 'comments/view', $ans['comment_id'], 'full_base' => true));
									?></span>
								</div>
							</li>
							<?php } 
