	...
	<div class="col-md-12">
		<div class="portlet box blue ">
			<div class="portlet-title">
				<div class="caption"><i class="fa fa-gift"></i><?php echo empty($parent) ? __('Add Company') : __('Add Group'); ?></div>
			</div>
				...
				<?php echo $this->Form->create('CompanyGroup', array(
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5"><?php echo $this->Form->input('parent_id', array('empty' => '--SELECT--', 'value' => $parent)); ?></div>
						</div>
					</div>
