<?php
	...
	echo '<br />';
	echo $$data['sender'].'<p style="text-align: center;"> has shared their story with you, please take a moment and give them some feedback.</p>';
	echo 'Please <a href="'.Router::url('/', true).'/feedbacks/feedback_view_individual/'.$data['invitationID'].'">Click Here</a> to get started.<br />';
