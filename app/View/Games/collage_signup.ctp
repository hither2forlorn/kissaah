<div class='no-margin row'>
	<div class='col-xs-7 col-sm-7 col-md-7 col-lg-7'>
		...
		<?php
		echo $this->Html->para('margin-top-10', 'In your Kissaah game,you will be using an interactive vision board which you 
								 				 will populate with your own images and other content.');
	    echo $this->Html->tag('strong', 'This is called your RoadMap');
		echo $this->Html->para('margin-top-10 margin-bottom-20', 'Once you\'ve completed your RoadMap, Kissaah can 
								...
								outside of the Kissaah Community.');
		echo $this->Html->para('margin-top-10 margin-bottom-20', 'You can also consent to let Kissaah use your RoadMap 
								Collage in order to inspire other people also using Kissaah.');
		 echo $this->Html->para('margin-top-10 margin-bottom-20', 'Completed RoadMaps show where you were, and what 
		 						you\'ve gained and achieved through the game, and this is great for the Kissaah Community to see!');
		?>
	</div>
	<div class='col-xs-5 col-sm-5 col-md-5 col-lg-5 '>
		...
		echo $this->Html->link('Let Kissaah use my RoadMap Collage publicly to inspire others ' .
				$this->Html->tag('span', '(RoadMap collages may appear on the 
					Kissaah website and/or social media pages)', array('class' => 'btn-collage-small')), 
				array('controller' => 'users' , 'action' => 'edit'), 
